...
windmill.registry.methods = {
  ...
  '-- Editor --': {'locator': false, 'option': false, 'section': true},
  'editor':{'locator':true,'option':'editor'},
  'editorSelect': {'locator': true, 'option': 'text'},
  '-- Amberjack --': {'locator': false, 'option': false, 'section': true},
  'highlight': {'locator': false, 'option': 'locators'},
